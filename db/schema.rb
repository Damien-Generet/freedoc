...
ActiveRecord::Schema[7.1].define(version: 2024_02_07_211243) do
  ...
  create_table "medical_specialities", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_medical_specialities_on_doctor_id"
    t.index ["speciality_id"], name: "index_medical_specialities_on_speciality_id"
  end
